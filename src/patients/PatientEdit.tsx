...
const PatientEdit: FC<EditProps> = props => {
  const classes = useStyles();
  return (
    <Edit {...props} mutationMode={"pessimistic"}>
      <TabbedForm  redirect="show">
        <FormTab label="resources.patients.tabs.details">
            <TextField source="id" fullWidth formClassName={classes.w50pc} className={classes.w60pc}/>
            ...
            <SelectInput source="testResult" choices={TEST_RESULTS_OPTIONS}/>
