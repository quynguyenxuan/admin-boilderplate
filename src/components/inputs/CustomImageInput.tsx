...
export const CustomImageInput = (props: any) => {
  ...
  const onDrop = //useCallback(
    async (acceptedFiles: any, rejectedFiles: any, event: any) => {
    ...
    <>
      ...
      <div style={{}}>
        {files?.map((item: any, index: number) => 
          <img src={item} key={index} style={{maxHeight: 142, marginRight: 10, width: 'auto', marginBottom: 10, border: '1px solid #ccc6c685', borderRadius: 5}}/>
        )}
